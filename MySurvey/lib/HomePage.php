	...
	protected function head(){
		...
		$ret.= '
			...
			if (isset($_SESSION['loggedin'])) {
													$ret.='		<a class="top-bar__nav__item" action="index.php?p=login&logout=true" method="post"> Log out </a>';}
			else{
													$ret.='		<a class="top-bar__nav__item" href="index.php?p=login"> Log in </a>';}
